const projects = [
  ...
  },
  {
    ...
    imagePaths: ["images/portfolio/binaural.png"],
  ...
  },
  {
    ...
    imagePaths: ["images/portfolio/foodora.png"],
  ...
  },
  {
    title: "Portfolio",
    subTitle: "React",
    techs: ["React", "React Router", "HTML", "CSS", "Netlify", "Enzyme"],
    description:
      "Built to display my projects and to provide an easy point of contact.",
    imagePaths: ["images/portfolio/portfolio.png"],
  ...
  },
  {
    ...
    imagePaths: ["images/portfolio/senna.png"],
  ...
  },
  {
    ...
    imagePaths: ["images/portfolio/petful.png"],
  ...
  },
  {
    ...
    imagePaths: ["images/portfolio/noteful.png"],
  ...
  },
  {
    title: "Bookmarks",
    subTitle: "Javascript",
    techs: ["CSS", "HTML5", "jQuery", "Javascript"],
    description:
      "Developed an app to help users store bookmarked websites. Enabled users to add a title, description, url and also rate the site between 1-5 stars.",
    imagePaths: ["images/portfolio/bookmarks.png"],
  ...
  },
  {
    ...
    description:
      "Quiz App was created with the intent to show a simple quiz that the user can answer questions. The theme of the app is Space. The user can check at each answers if their questions are right or wrong. In the end there is a summon up of all they can see their final score.",
    imagePaths: ["images/portfolio/quiz.png"],
